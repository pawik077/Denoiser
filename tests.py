...
def full_test(datasets):
    ...
    plt.figure()
    plt.title('PSNR')
    plt.bar(['GT', 'REDNet', 'MWCNN', 'PRIDNet', 'NLM'], [psnr_gt_mean, psnr_rednet_mean, psnr_mwcnn_mean, psnr_pridnet_mean, psnr_nlm_mean])
    plt.savefig(f'./test/{testname}psnr.png')
    plt.figure()
    plt.title('SSIM')
    plt.bar(['GT', 'REDNet', 'MWCNN', 'PRIDNet', 'NLM'], [ssim_gt_mean, ssim_rednet_mean, ssim_mwcnn_mean, ssim_pridnet_mean, ssim_nlm_mean])
    plt.savefig(f'./test/{testname}ssim.png')
    plt.figure()
    plt.title('MSE')
    plt.bar(['GT', 'REDNet', 'MWCNN', 'PRIDNet', 'NLM'], [mse_gt_mean, mse_rednet_mean, mse_mwcnn_mean, mse_pridnet_mean, mse_nlm_mean])
...
def single_test(gt_path, noisy_path):
    ...
    plt.figure()
    plt.title('PSNR')
    plt.bar(['GT', 'REDNet', 'MWCNN', 'PRIDNet', 'NLM'], [psnr_gt, psnr_rednet, psnr_mwcnn, psnr_pridnet, psnr_nlm])
    plt.savefig(f'./test/single_psnr.png')
    plt.figure()
    plt.title('SSIM')
    plt.bar(['GT', 'REDNet', 'MWCNN', 'PRIDNet', 'NLM'], [ssim_gt, ssim_rednet, ssim_mwcnn, ssim_pridnet, ssim_nlm])
    plt.savefig(f'./test/single_ssim.png')
    plt.figure()
    plt.title('MSE')
    plt.bar(['GT', 'REDNet', 'MWCNN', 'PRIDNet', 'NLM'], [mse_gt, mse_rednet, mse_mwcnn, mse_pridnet, mse_nlm])
